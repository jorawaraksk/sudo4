...
async def send_start(client: Client, message: Message):
    buttons = [[
        InlineKeyboardButton("SHINchan", url = "https://t.me/jdkskssbsbjdjdkss")
    ],[
        InlineKeyboardButton(' Mitsi nohara', url='https://t.me/Odjdjsjsbdhdisksksksks'),
        InlineKeyboardButton('🤖 Himawari', url='https://t.me/OjdjskssksnnsnsksksskD')
	]]
